...
submitted to the Waffle-DB project.

Waffle-DB is an open-source project intended to remain free, public, and
...
- Waffle-DB will remain an **open-source project**
...
This Agreement is **not** intended to take community work and close it off from
the public.
...
- This Agreement does **not** transfer ownership of your work away from you.
...
- include them as part of Waffle-DB
...
- All Contributions will be made publicly available under the
  **GNU General Public License (GPL)** as part of Waffle-DB.
...
Submitting a Contribution to Waffle-DB means you accept this Agreement.
